...
\semester{2024 Winter}                                % SEMESTRE (202X A/B)
...
\begin{enumerate}
    ...
    \item Option C:
     ...
     Th...
     \item Option ?:
     The purpose of feature scaling in machine learning is to ...
     \item Option ?:
     The appropriate evaluation metrics for a binary classification problem is ...
     \item Option ?:
     The appropriate evaluation metrics for a binary classification problem is ...
     \item Option ?:
     The appropriate evaluation metrics for a binary classification problem is ...
